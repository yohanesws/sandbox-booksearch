 ...
 */
package io.yohanes.test.bookstore.dynamoDb;
...
public interface IDynamoDBKeys {
    final static String full_dynamodb_access_ID = "ID";
    final static String full_dynamodb_access_KEY = "KEYS";
    
    // The AWS region for the DynamoDB instance.
    // Singapore
    final static Regions region = Regions.AP_SOUTHEAST_1;
}
